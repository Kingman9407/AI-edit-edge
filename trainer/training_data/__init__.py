...
# from training_data.c15_undo_edits    import examples as c15
# from training_data.c16_json_correction import examples as c16
...
CATEGORY_COUNTS = {
    ...
    # "c15_undo_edits":         len(c15),
    # "c16_json_correction":    len(c16),
}
